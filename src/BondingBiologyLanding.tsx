...
function WhoFor() {
  const cards = [
    "You’re accomplished, attractive, and emotionally aware — yet commitment still feels inconsistent.",
    "You don’t want more games, scripts, or “be less available” advice.",
    "You want a mechanism you can understand, not a personality you have to fake.",
    "You’re ready to stop auditioning for love and let commitment reveal itself.",
  ];
  return (
