    ...
    try {
      await fetch(GHL_WEBHOOK_URL, {
        ...
        body: JSON.stringify({
          ...
          q3_question: answers[2]?.question,
          q3_answer: answers[2]?.answer,
          q4_question: answers[3]?.question,
          q4_answer: answers[3]?.answer,
          q5_question: answers[4]?.question,
          q5_answer: answers[4]?.answer,
          q6_question: answers[5]?.question,
          q6_answer: answers[5]?.answer,
          q7_question: answers[6]?.question,
